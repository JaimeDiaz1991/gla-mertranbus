...
public class Gestor_Rutas {	
	...
	public static void crear_ruta(String origen, String destino,double kms, String descripcion) throws SQLException{
		Ruta ruta1 =new Ruta(origen, destino,kms,descripcion);
		persistencia.Agente.crear_ruta(ruta1);
	}
	public static void modificar_ruta(int ID,String origen, String destino,double kms, String descripcion) throws SQLException{
	...
	public static ArrayList<Ruta> visualizar_ruta(String busqueda,String cadena) throws SQLException{
		persistencia.Agente agente1 = new persistencia.Agente();
	...
	public static Ruta cargar_ruta(int ID) throws SQLException{
		persistencia.Agente agente1 = new persistencia.Agente();
